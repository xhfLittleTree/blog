    ...
    nav: [
      { text: '首页', link: '/' },
      {
        ...
        items: [
          ...
          //   ],
          // },
          { text: 'qiankun缓存问题', link: '/pages/20230912160500/' },
          { text: 'ws连接中断问题', link: '/pages/20230911105900/' },
          { text: '内存泄漏问题', link: '/pages/20231206105901/' },
      ...
      },
      {
        ...
        link: '/life/',
        items: [
          { text: '笔记', link: '/pages/20230912163700/' },
        ],
      },
      {
        text: '摄像',
        link: '/photo/',
        items: [
          { text: '日出', link: '/pages/20230911160502/' },
          { text: '陪伴', link: '/pages/20230911160503/' },
          { text: '松鼠', link: '/pages/20230901160504/' },
          { text: '母子', link: '/pages/20230911160505/' },
        ],
      },
    ],
    sidebarDepth: 2, // 侧边栏显示深度，默认1，最大2（显示到h3标题）
    logo: '/img/头像.png', // 导航栏logo
  ...
  //   ],
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: 'd07c26f029742cd7e49f',
          clientSecret: '0db47b99d1776c25af34ef56d77fadf1d31aa326',
          repo: 'TreeComment', // GitHub 仓库
          owner: 'xhfLittleTree', // GitHub仓库所有者
          admin: ['xhfLittleTree'], // 对仓库有写权限的人
