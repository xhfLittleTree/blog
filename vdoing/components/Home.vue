    ...
    <MainLayout>
      ...
      <template v-if="!homeData.hideRightBar" #mainRight>
        ...
        <CategoriesBar
          ...
          :length="10"
        />
        <MychartsBar :category="$themeConfig.nav"></MychartsBar>
        <TagsBar
...
import MychartsBar from '@theme/components/MychartsBar'
...
export default {
  ...
  components: { NavLink, MainLayout, PostList, UpdateArticle, BloggerBar, CategoriesBar, TagsBar, Pagination,MychartsBar },
  created() {
